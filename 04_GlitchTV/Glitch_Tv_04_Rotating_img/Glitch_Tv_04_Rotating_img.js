//GLITCH TV variation 04
//rotating background image every 2 seconds 
...
let img, imgXoffset;
let imgs = [];
let currentImgIndex = 0; // CHANGE
let lastImageChange = 0; // CHANGE
let imageChangeInterval = 2000; // every 2 seconds the background image changes

let counter = 0; //this is for the screenshot function at the end of the code

function preload() {
  const files = [ //CHANGE lOADING THREE IMG
    'data/96aa8173-f2e0-437b-b545-c9259b403789-2.jpeg',
    'data/d0017326-cc1a-4676-8aa0-f5d034764bc2.jpeg',
    'data/8569e2ab-1257-4841-b9aa-98f067f50c05.jpeg'
  ];
...
function draw() {
    ...
    if (millis() - lastImageChange > imageChangeInterval) {
    ...
    // Glitchy horizontal bars - random coloured strips
    for (let i = 0; i < 15; i++) {
        ...
        let bri = random(150, 255);    // Low brightness
...
//    if (key === 's' || key === 'S') {
//        saveCanvas(`Glitch_Tv_03_Bar_Colour_Change`, 'jpg'); 
//        counter++;
        
// Save a 5-second gif
function keyPressed() {
  if (key === 's') {
    saveGif('Glitch_Tv_04_Rotating_img', 5);
  }
}
