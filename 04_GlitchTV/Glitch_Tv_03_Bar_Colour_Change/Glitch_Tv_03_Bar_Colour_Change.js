//GLITCH TV variation 03
//Colour of bars change to neon
//img change
 // ============================================
...
function preload() {
    img = loadImage('data/d0017326-cc1a-4676-8aa0-f5d034764bc2.jpeg');
}
...
function setup() {
    ...
    backgroundOpacity = 0;
    backgroundFadeDirection = -5; // 1 = increasing, -1 = decreasing
}
...
function keyPressed() {
  if (key === 's') {
    saveGif('Glitch_Tv_03_Bar_Colour_Change', 5);
  }
}
