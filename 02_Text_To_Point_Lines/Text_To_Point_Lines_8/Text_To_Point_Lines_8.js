// Text to point lines variation 08
// Change = removed ellipses entirely, left with the outlines from the lines
// kept the lines still and changed colour to blue
...
function draw() {
  ...
  //////CHANGE
  //let maxReach = 400; // max distance at which lines appear
...
function keyPressed() {
  if (key === 's') {
    saveGif('Text_To_Point_Lines_8', 5); // Saves 5 seconds of animation
  } 
}
